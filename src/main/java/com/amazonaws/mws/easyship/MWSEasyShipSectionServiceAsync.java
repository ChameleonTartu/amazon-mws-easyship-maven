...
public interface MWSEasyShipSectionServiceAsync extends MWSEasyShipSectionService {
     ...
     * @return {@code Future<CreateScheduledPackageResponse>} response.
     */
     ...
     * @return {@code Future<GetScheduledPackageResponse>} response.
     */
     ...
     * @return {@code Future<ListPickupSlotsResponse>} response.
     */
     ...
     * @return {@code Future<UpdateScheduledPackagesResponse>} response.
     */
